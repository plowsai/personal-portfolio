...
const projects: Project[] = [
  {
    title: 'Human AI',
    description: 'humanturk.com',
    githubUrl: 'https://github.com/humanturk',
    date: '2025-08-14'
  }
]
...
export function BuildingInPublic() {
  ...
  return (
    <div className="space-y-8">
      <h2 className="text-xl font-semibold tracking-tighter">Latest Project</h2>
          ...
          >
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                <Link 
                  href="https://humanturk.com"
                  target="_blank"
                  rel="noopener noreferrer"
                  className={`font-medium transition-all duration-500 hover:underline ${
              ...
              <div className="space-y-2">
                <Link 
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-neutral-700 dark:text-neutral-300 hover:text-blue-500 dark:hover:text-blue-400 hover:underline"
                >
                  {project.description}
                </Link>
                <Link 
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center text-sm text-neutral-700 dark:text-neutral-300 hover:text-neutral-900 dark:hover:text-neutral-100"
                >
                  <svg 
